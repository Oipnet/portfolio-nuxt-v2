...
<template>
  <header class="header grid grid-cols-1 md:grid-cols-header w-full mt-8 items-center gap-8">
    <div class="header--title text-right pr-16">
  ...
  <div class="h-1 mt-8 bg-primary-hover mx-8"></div>
</template>
